...
*/
void CalcularMinimo(std::vector<int> V) {
...
* @param vector V : vector donde calcularemos el maximo.
*/
void CalcularMaximo(std::vector<int> V) {
  auto res = minmax_element(V.begin(), V.end());
...
* @param tamanio : tamaño del vector, vector V : vector donde calcularemos el promedio.
*/
void CalcularPromedio(int tamanio, std::vector<int> V) {
  double suma;
